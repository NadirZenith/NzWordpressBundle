 ...
 * @ORM\Entity(repositoryClass="Nz\WordpressBundle\Repository\CommentRepository")
...
class Comment
{
     ...
     * {@inheritdoc}
     *
     * @ORM\OneToMany(targetEntity="Nz\WordpressBundle\Entity\CommentMeta", mappedBy="comment")
     */
    protected $metas;
     ...
     * {@inheritdoc}
     *
     * @ORM\ManyToOne(targetEntity="Nz\WordpressBundle\Entity\Post", inversedBy="comments")
     * @ORM\JoinColumns({
     ...
     * {@inheritdoc}
     *
     * @ORM\ManyToOne(targetEntity="Nz\WordpressBundle\Entity\User", inversedBy="comments")
     * @ORM\JoinColumns({
