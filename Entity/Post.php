...
namespace Nz\WordpressBundle\Entity;
...
use Nz\WordpressBundle\Annotation as Wordpress;
 ...
 * @ORM\Entity(repositoryClass="Nz\WordpressBundle\Repository\PostRepository")
...
class Post
{
     ...
     * {@inheritdoc}
     *
     * @ORM\OneToMany(targetEntity="Nz\WordpressBundle\Entity\PostMeta", mappedBy="post", cascade={"persist"})
     */
    protected $metas;
     ...
     * {@inheritdoc}
     *
     * @ORM\OneToMany(targetEntity="Nz\WordpressBundle\Entity\Comment", mappedBy="post", cascade={"persist"})
     */
    protected $comments;
     ...
     * {@inheritdoc}
     *
     * @ORM\ManyToOne(targetEntity="Nz\WordpressBundle\Entity\User", inversedBy="posts")
     * @ORM\JoinColumns({
     ...
     * {@inheritdoc}
     *
     * @ORM\ManyToMany(targetEntity="Nz\WordpressBundle\Entity\Taxonomy", inversedBy="posts")
     ...
     * Set parent
     *
     * @param \Nz\WordpressBundle\Entity\Post $parent
     */
     ...
     * Get parent
     *
     * @return \Nz\WordpressBundle\Entity\Post
     */
