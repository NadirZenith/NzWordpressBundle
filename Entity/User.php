...
/**
 * Nz\WordpressBundle\Entity\User
 *
...
class User implements UserInterface, Serializable
{
     ...
     * {@inheritdoc}
     *
     * @ORM\OneToMany(targetEntity="Nz\WordpressBundle\Entity\UserMeta", mappedBy="user", cascade={"persist"})
     */
    protected $metas;
     ...
     * {@inheritdoc}
     *
     * @ORM\OneToMany(targetEntity="Nz\WordpressBundle\Entity\Post", mappedBy="user")
     */
    protected $posts;
     ...
     * {@inheritdoc}
     *
     * @ORM\OneToMany(targetEntity="Nz\WordpressBundle\Entity\Comment", mappedBy="user")
     */
    protected $comments;
