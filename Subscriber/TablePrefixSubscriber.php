...
namespace Nz\WordpressBundle\Subscriber;
...
use Nz\WordpressBundle\Annotation\WordpressTable;
...
class TablePrefixSubscriber implements EventSubscriber
{
    ...
    private function getPrefix($entityName, $em)
    {
        ...
        if ($entityName === 'Nz\WordpressBundle\Entity\User' ||
            $entityName === 'Nz\WordpressBundle\Entity\UserMeta') {
            return $this->prefix;
        }
